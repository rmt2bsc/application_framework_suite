 ...
 * 
 */
public class DatabaseTransactionErrorException extends DatabaseException {
     ...
     * 
     */
    public DatabaseTransactionErrorException() {
        super();
    }
     ...
     */
    public DatabaseTransactionErrorException(String msg) {
        super(msg);
    }
     ...
     *            The exception code.
     */
    public DatabaseTransactionErrorException(String msg, int code) {
        super(msg, code);
    }
     ...
     *            Exception
     */
    public DatabaseTransactionErrorException(Exception e) {
        super(e);
    }
     ...
     * 
     */
    public DatabaseTransactionErrorException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
