...
public class LdapAppServer {
    ...
    /**
     * Creates a LdapAppServer object withou intializing any of its properties.
     */
    public LdapAppServer() {
        super();
    }
     ...
     */
    public void setSerialExt(String serialExt) {
    ...
    /**
     * @param computerTypeCatg
     *            the computerTypeCatg to set
     */
    public void setComputerTypeCatg(String computerTypeCatg) {
        this.computerTypeCatg = computerTypeCatg;
    }

    /**
     * @return the computerTypeCatgBoxDescr
     */
    public String getComputerTypeCatgBoxDescr() {
        return computerTypeCatgBoxDescr;
    }

    /**
     * @param computerTypeCatgBoxDescr
     *            the computerTypeCatgBoxDescr to set
     */
    public void setComputerTypeCatgBoxDescr(String computerTypeCatgBoxDescr) {
        this.computerTypeCatgBoxDescr = computerTypeCatgBoxDescr;
    }

    /**
     * @return the mailInternalSmtpDomain
     */
    public String getMailInternalSmtpDomain() {
        return mailInternalSmtpDomain;
    }

    /**
     * @param mailInternalSmtpDomain
     *            the mailInternalSmtpDomain to set
     */
    public void setMailInternalSmtpDomain(String mailInternalSmtpDomain) {
        this.mailInternalSmtpDomain = mailInternalSmtpDomain;
    }
