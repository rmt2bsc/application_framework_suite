 ...
 *
 */
public abstract class AbstractSdiModelessWindow extends JFrame implements
    ...
    private static final Logger logger = Logger
            .getLogger(AbstractSdiModelessWindow.class);
     ...
     */
    public AbstractSdiModelessWindow() throws HeadlessException {
        super();
     ...
     * @throws HeadlessException
     */
    public AbstractSdiModelessWindow(Dimension size, Point pos, String winTitle)
            throws HeadlessException {
        super();
        this.size = size;
        this.position = pos;
        ...
        this.initFrame();
        this.setIconImage(GuiEnvSetup.getAppIcon().getImage());
        this.updateView();
    }
    ...
    private void addInstance() {
        if (AbstractSdiModelessWindow.SINGLE_FRAME_INSTANCES == null) {
            AbstractSdiModelessWindow.SINGLE_FRAME_INSTANCES = new HashMap<String, String>();
        }
        String winName = this.getClass().getSimpleName();
        AbstractSdiModelessWindow.SINGLE_FRAME_INSTANCES.put(winName, winName);
    }
    ...
    private boolean removeInstance() {
        if (AbstractSdiModelessWindow.SINGLE_FRAME_INSTANCES != null) {
            String winName = AbstractSdiModelessWindow.SINGLE_FRAME_INSTANCES
