...
/**
 * A multi-line table cell renderer for {@link DataGrid}.
 * 
 * @author appdev
 *
 */
public class CustomTextAreaCellRenderer extends JTextArea implements
        TableCellRenderer {
     ...
     * 
     */
    public CustomTextAreaCellRenderer() {
        this.setLineWrap(true);
        this.setWrapStyleWord(true);
        this.setOpaque(true);
        this.rowColHeight = new ArrayList<List<Integer>>();
    }
