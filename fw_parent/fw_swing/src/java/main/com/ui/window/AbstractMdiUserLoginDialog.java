 ...
 *
 */
public abstract class AbstractMdiUserLoginDialog extends AbstractMdiModalWindow {

    private static final long serialVersionUID = 1062235214399626383L;

    private static final Logger logger = Logger
            .getLogger(AbstractMdiUserLoginDialog.class);
     ...
     * 
     */
    public AbstractMdiUserLoginDialog(String title, Object data,
    ...
    private void validateInput() throws InvalidDataException {
        if (this.userIdField.getText() == null
            ...
            AbstractMdiUserLoginDialog.logger.error(this.msg);
