 ...
 *
 */
public abstract class AbstractSdiMainFrame extends JFrame {
    ...
    private class PostUiInitializer extends SwingWorker<Void, Void> {
        private AbstractSdiMainFrame parent;

        protected PostUiInitializer(AbstractSdiMainFrame frame) {
            this.parent = frame;
        }
        ...
        protected Void doInBackground() throws Exception {
            ...
            try {
                ...
                AbstractSdiMainFrame.logger
                        .fatal("Application failed to start due to post intialization error!");
                AbstractSdiMainFrame.logger.fatal(buf, e);
    ...
    protected void initializeApp() {
        ...
        try {
            ...
            AbstractSdiMainFrame.logger = Logger
                    .getLogger(AbstractSdiMainFrame.class);
            AbstractSdiMainFrame.logger.info("Logger initialization completed");
