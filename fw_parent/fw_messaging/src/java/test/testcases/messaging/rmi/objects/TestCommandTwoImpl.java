 ...
 * 
 */
public class TestCommandTwoImpl implements RmiServiceCommand {

    /**
     * 
     */
    public TestCommandTwoImpl() {
    ...
    public MessageHandlerResults processMessage(MessageHandlerInput req)
        ...
        r.setReturnCode(1);
        r.setPayload("this is a test results from TestCommandTwoImpl...RMI call successful!");
        r.setErrorMsg("This is error message #2");
        return r;
    }
