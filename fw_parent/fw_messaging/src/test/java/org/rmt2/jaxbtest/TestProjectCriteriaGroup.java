...
public class TestProjectCriteriaGroup
    extends RMT2Base
    implements Serializable
{
    ...
    protected TestEmployeeCriteriaType employeeCriteria;
    @XmlElement(name = "timesheet_criteria")
    protected List<TestTimesheetCriteriaType> timesheetCriteria;
     ...
     *     
     */
    public TestEmployeeCriteriaType getEmployeeCriteria() {
     ...
     *     
     */
    public void setEmployeeCriteria(TestEmployeeCriteriaType value) {
     ...
     * 
     */
    public List<TestTimesheetCriteriaType> getTimesheetCriteria() {
        if (timesheetCriteria == null) {
            timesheetCriteria = new ArrayList<TestTimesheetCriteriaType>();
        }
