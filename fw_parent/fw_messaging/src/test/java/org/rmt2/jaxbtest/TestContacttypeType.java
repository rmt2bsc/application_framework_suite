...
@XmlEnum
public enum TestContacttypeType {
    ...
    public static TestContacttypeType fromValue(String v) {
        for (TestContacttypeType c: TestContacttypeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
