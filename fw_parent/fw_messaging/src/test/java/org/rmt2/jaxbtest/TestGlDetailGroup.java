...
public class TestGlDetailGroup
    extends RMT2Base
    implements Serializable
{
    ...
    protected List<TestGlAccounttypeType> accountTypes;
    @XmlElement(name = "account_categories")
    protected List<TestGlAccountcatgType> accountCategories;
    protected List<TestGlAccountType> accounts;
     ...
     * 
     */
    public List<TestGlAccounttypeType> getAccountTypes() {
        if (accountTypes == null) {
            accountTypes = new ArrayList<TestGlAccounttypeType>();
        }
     ...
     * 
     */
    public List<TestGlAccountcatgType> getAccountCategories() {
        if (accountCategories == null) {
            accountCategories = new ArrayList<TestGlAccountcatgType>();
        }
     ...
     * 
     */
    public List<TestGlAccountType> getAccounts() {
        if (accounts == null) {
            accounts = new ArrayList<TestGlAccountType>();
        }
