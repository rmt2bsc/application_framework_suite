...
public class TestPurchaseOrderType
    extends RMT2Base
    implements Serializable
{
    ...
    protected TestXactType transaction;
    @XmlElement(required = true)
    ...
    protected List<TestPurchaseOrderItemType> items;
     ...
     *     
     */
    public TestXactType getTransaction() {
        return transaction;
    }
     ...
     *     
     */
    public void setTransaction(TestXactType value) {
     ...
     * 
     */
    public List<TestPurchaseOrderItemType> getItems() {
        if (items == null) {
            items = new ArrayList<TestPurchaseOrderItemType>();
        }
        return this.items;
    }
