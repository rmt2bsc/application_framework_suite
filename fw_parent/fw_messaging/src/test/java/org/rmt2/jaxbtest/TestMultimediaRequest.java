...
public class TestMultimediaRequest
    extends RMT2Base
    implements Serializable
{
    ...
    protected List<TestMimeContentType> content;
     ...
     * 
     */
    public List<TestMimeContentType> getContent() {
        if (content == null) {
            content = new ArrayList<TestMimeContentType>();
        }
        return this.content;
    }
