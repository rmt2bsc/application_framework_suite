...
public class TestTransactionDetailGroup
    extends RMT2Base
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    protected List<TestXactType> transaction;
    protected List<TestCreditorType> creditor;
    protected List<TestCustomerType> customer;
    @XmlElement(name = "purchase_order")
    protected List<TestPurchaseOrderType> purchaseOrder;
    @XmlElement(name = "sales_order")
    protected List<TestSalesOrderType> salesOrder;
     ...
     * 
     */
    public List<TestXactType> getTransaction() {
        if (transaction == null) {
            transaction = new ArrayList<TestXactType>();
        }
     ...
     * 
     */
    public List<TestCreditorType> getCreditor() {
        if (creditor == null) {
            creditor = new ArrayList<TestCreditorType>();
        }
     ...
     * 
     */
    public List<TestCustomerType> getCustomer() {
        if (customer == null) {
            customer = new ArrayList<TestCustomerType>();
        }
     ...
     * 
     */
    public List<TestPurchaseOrderType> getPurchaseOrder() {
        if (purchaseOrder == null) {
            purchaseOrder = new ArrayList<TestPurchaseOrderType>();
        }
     ...
     * 
     */
    public List<TestSalesOrderType> getSalesOrder() {
        if (salesOrder == null) {
            salesOrder = new ArrayList<TestSalesOrderType>();
        }
