...
public class TestContactDetailGroup
    extends RMT2Base
    implements Serializable
{
    ...
    protected List<TestBusinessType> businessContacts;
    @XmlElement(name = "person_contacts")
    protected List<TestPersonType> personContacts;
    @XmlElement(name = "common_contacts")
    protected List<TestCommonContactType> commonContacts;
     ...
     * 
     */
    public List<TestBusinessType> getBusinessContacts() {
        if (businessContacts == null) {
            businessContacts = new ArrayList<TestBusinessType>();
        }
     ...
     * 
     */
    public List<TestPersonType> getPersonContacts() {
        if (personContacts == null) {
            personContacts = new ArrayList<TestPersonType>();
        }
     ...
     * 
     */
    public List<TestCommonContactType> getCommonContacts() {
        if (commonContacts == null) {
            commonContacts = new ArrayList<TestCommonContactType>();
        }
