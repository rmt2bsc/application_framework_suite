...
public class TestResourceExtType
    extends RMT2Base
    implements Serializable
{
    ...
    protected TestResourceType rsrcType;
    @XmlElement(name = "rsrc_sub_type", required = true, nillable = true)
    protected TestResourceSubtypeType rsrcSubType;
     ...
     *     
     */
    public TestResourceType getRsrcType() {
        return rsrcType;
    }
     ...
     *     
     */
    public void setRsrcType(TestResourceType value) {
        this.rsrcType = value;
    }
     ...
     *     
     */
    public TestResourceSubtypeType getRsrcSubType() {
        return rsrcSubType;
    }
     ...
     *     
     */
    public void setRsrcSubType(TestResourceSubtypeType value) {
