...
public class TestUserAppRolesType
    extends RMT2Base
    implements Serializable
{
    ...
    protected TestUserType userInfo;
    @XmlElement(name = "app_info", required = true, nillable = true)
    protected TestApplicationType appInfo;
    @XmlElement(name = "assigned_roles", nillable = true)
    protected List<TestAppRoleType> assignedRoles;
    @XmlElement(name = "revoked_roles", nillable = true)
    protected List<TestAppRoleType> revokedRoles;
     ...
     *     
     */
    public TestUserType getUserInfo() {
        return userInfo;
    }
     ...
     *     
     */
    public void setUserInfo(TestUserType value) {
        this.userInfo = value;
    }
     ...
     *     
     */
    public TestApplicationType getAppInfo() {
        return appInfo;
    }
     ...
     *     
     */
    public void setAppInfo(TestApplicationType value) {
        this.appInfo = value;
    }
     ...
     * 
     */
    public List<TestAppRoleType> getAssignedRoles() {
        if (assignedRoles == null) {
            assignedRoles = new ArrayList<TestAppRoleType>();
        }
     ...
     * 
     */
    public List<TestAppRoleType> getRevokedRoles() {
        if (revokedRoles == null) {
            revokedRoles = new ArrayList<TestAppRoleType>();
        }
