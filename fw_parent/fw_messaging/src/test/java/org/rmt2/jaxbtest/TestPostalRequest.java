...
public class TestPostalRequest
    extends RMT2Base
    implements Serializable
{
    ...
    protected TestPostalRequest.PostalCriteria postalCriteria;
     ...
     *     
     */
    public TestPostalRequest.PostalCriteria getPostalCriteria() {
     ...
     *     
     */
    public void setPostalCriteria(TestPostalRequest.PostalCriteria value) {
        ...
        implements Serializable
    {
        ...
        private final static long serialVersionUID = 1L;
        protected TestZipcodeCriteriaType zipcode;
        protected TestCountryCriteriaType country;
        protected TestStatesCriteriaType province;
        @XmlElement(name = "ip_addr")
        protected TestIpCriteriaType ipAddr;
        protected TestTimezoneCriteriaType timezone;
         ...
         *     
         */
        public TestZipcodeCriteriaType getZipcode() {
            return zipcode;
        }
         ...
         *     
         */
        public void setZipcode(TestZipcodeCriteriaType value) {
            this.zipcode = value;
        }
         ...
         *     
         */
        public TestCountryCriteriaType getCountry() {
            return country;
        }
         ...
         *     
         */
        public void setCountry(TestCountryCriteriaType value) {
            this.country = value;
        }
         ...
         *     
         */
        public TestStatesCriteriaType getProvince() {
            return province;
        }
         ...
         *     
         */
        public void setProvince(TestStatesCriteriaType value) {
            this.province = value;
        }
         ...
         *     
         */
        public TestIpCriteriaType getIpAddr() {
            return ipAddr;
        }
         ...
         *     
         */
        public void setIpAddr(TestIpCriteriaType value) {
            this.ipAddr = value;
        }
         ...
         *     
         */
        public TestTimezoneCriteriaType getTimezone() {
            return timezone;
        }
         ...
         *     
         */
        public void setTimezone(TestTimezoneCriteriaType value) {
            this.timezone = value;
        }
