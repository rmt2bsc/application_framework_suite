...
/**
 * Uses distributed resources to perform the initialization of the application
 * by loading system environment variables and application properties,
 * establishing the JDBC connection pool, and setting the the application's
 * logger.
 * <p>
 * User-defined JVM and application properties are loaded into memory from
 * distributed resource contexts such as the web container or other remote
 * applications.
 * 
 * @author Roy Terrell
 * 
 */
public class DistributedApiConfigTestDelegate extends RMT2Base {
     ...
     * 
     */
    public DistributedApiConfigTestDelegate() {
        this.appName = "Unknown Application";
        this.containerManagedPool = false;
    }

    public DistributedApiConfigTestDelegate(String configFile) {
        this();
        this.propFile = configFile;
        return;
    }

    public DistributedApiConfigTestDelegate(String appName,
